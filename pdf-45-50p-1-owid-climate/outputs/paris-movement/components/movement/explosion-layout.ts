// Adapted from ashemag/human-atlas (MIT); see HUMAN-ATLAS-LICENSE.
export type LayoutPart={id:string;bounds:[[number,number,number],[number,number,number]]};
...
export function createExplosionLayout(parts:LayoutPart[],aspect=1){
